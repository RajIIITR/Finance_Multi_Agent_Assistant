...
def setup_environment():
    ...
    print(f"DEBUG: GOOGLE_API_KEY found: {bool(GOOGLE_API_KEY)}")
    print(f"DEBUG: LANGCHAIN_API_KEY found: {bool(LANGCHAIN_API_KEY)}")
    ...
    print("DEBUG: Environment variables set successfully")
...
def analyze_stock(ticker: str, question: str = "Should I buy this stock?") -> str:
    ...
    try:
        ...
        print(f"DEBUG: LANGCHAIN_API_KEY exists: {bool(os.getenv('LANGCHAIN_API_KEY'))}")
